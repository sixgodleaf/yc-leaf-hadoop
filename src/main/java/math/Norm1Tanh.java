...
public class Norm1Tanh extends DifferentiableMatrixFunction {
	...
	{
        System.out.println("Norm1Tanh 's derivativeAt is running");
        double norm = M.norm2();
        ...
        System.out.println("Norm1Tanh 's derivativeAt is finish");
        return p1.subi(p2);
	}
	...
	{
        System.out.println("Norm1Tanh 's valueAt is running");
