...
public class QNMinimizer implements Minimizer<DifferentiableFunction> {
	...
	public final void setRobustOptions() {
        System.out.println("QNMinimizer 's setRobustOptions is running");
        useAveImprovement = true;
	...
	public class Record {
		...
		public void add(double val, double[] grad, double[] x, int fevals) {
            System.out.println("QNMinimizer 's add is running");
			...
			xLast = x;
			monitorX(x);
            System.out.println("QNMinimizer 's add is finish");
        }
		...
		public eState toContinue() {
            System.out.println("QNMinimizer 's toContinue is running");
            ...
            System.out.println("QNMinimizer 's toContinue is finish");
	...
	public class QNInfo {
		...
		public void setHistory(List<double[]> sList, List<double[]> yList) {
            System.out.println("QNMinimizer 's setHistory is running");
            int size = sList.size();
            ...
            System.out.println("QNMinimizer 's setHistory is finish");

        }

		public double[] applyInitialHessian(double[] x) {
            System.out.println("QNMinimizer 's applyInitialHessian is running");
            ...
            System.out.println("QNMinimizer 's applyInitialHessian is finish");
			return x;
		...
		public int update(double[] newX, double[] x, double[] newGrad,
            ...
            System.out.println("QNMinimizer 's update is running");
            ...
            System.out.println("QNMinimizer 's update is finish");
       ...
       */
		...
		public int update(double[] newS, double[] newY, double yy, double sy,
            ...
            System.out.println("ZeroGradient 's update is running");
            ...
            System.out.println("ZeroGradient 's update is finish");
			return s.size();
		} // end update
	...
	private void computeDir(double[] dir, double[] fg, QNInfo qn)
        ...
        System.out.println("ZeroGradient 's computeDir is running");
        ...
        System.out.println("ZeroGradient 's computeDir is finish");
	...
	private static double[] plusAndConstMult(double[] a, double[] b, double c,
			double[] d) {
        System.out.println("ZeroGradient 's plusAndConstMult is running");
		for (int i = 0; i < a.length; i++) {
			d[i] = a[i] + c * b[i];
		}
        System.out.println("ZeroGradient 's plusAndConstMult is finish");
        return d;
	}
	...
	public double[] minimize(DifferentiableFunction dfunction,
        ...
        System.out.println("ZeroGradient 's minimize is running");
        ...
        System.out.println("minimize is finish");
        qn.free();
		return x;
