...
public class Theta implements Serializable{
	...
	{
        System.out.println("Theta 's setWe is running");
        this.We = We;
		System.arraycopy(We.toArray(), 0, Theta, Wbegins[4], hiddenSize * dictionaryLength);
        System.out.println("Theta 's setWe is finish");
	...
	{
        System.out.println("Theta 's InitializeMatrices is running");
        ...
        System.out.println("Theta 's InitializeMatrices is finish");

    }

	protected void InitializeMatricesToZeros()
	{
        System.out.println("Theta 's InitializeMatricesToZeros is running");
        Wbegins = new int[6];
		Wends = new int[6];
		bbegins = new int[6];
		bends = new int[6];
        ...
        System.out.println("Theta 's InitializeMatricesToZeros is finish");
    }
	
	protected void flatten(double[] Theta)
	{
        System.out.println("Theta 's flatten is running");
        ...
        System.out.println("Theta 's flatten is finish");
    }
	
	protected void fixIndices()
	{
        System.out.println("Theta 's fixIndices is running");
        ...
        System.out.println("Theta 's fixIndices is finish");
    }
}
